<<<<<<<< HEAD:tests_cpp14/utils/cpu_info.cpp
﻿#include <fea/utils/cpu_info.hpp>
========
﻿#include <fea/performance/cpu_info.hpp>
#include <fea/performance/cpuid_details/cpu_info2.hpp>
>>>>>>>> 15b018e (cpu_info : wip refactor):tests_cpp17/performance/cpu_info.cpp
...
TEST(cpu_info, basics) {
	...
	uint32_t t = fea::cpu_info_test::highest_leaf();
	printf("%u\n", t);
	std::string t2 = fea::cpu_info_test::vendor();
	printf("%s\n", t2.c_str());

	fea::cpu_info_test::print();
}
