...
namespace {
#define FAILMSG "average.cpp : Failed unit test."

TEST(moving_average, ca_unbounded) {
	static_assert(fea::ca<double>::is_int_v == false, FAILMSG);
	static_assert(fea::ca<float>::is_int_v == false, FAILMSG);
	static_assert(fea::ca<int64_t>::is_int_v == true, FAILMSG);
	static_assert(fea::ca<int>::is_int_v == true, FAILMSG);

	static_assert(std::is_same_v<typename fea::ca<double>::mfloat_t, double>,
			FAILMSG);
	static_assert(
			std::is_same_v<typename fea::ca<float>::mfloat_t, float>, FAILMSG);
	static_assert(std::is_same_v<typename fea::ca<int64_t>::mfloat_t, double>,
			FAILMSG);
	static_assert(
			std::is_same_v<typename fea::ca<int>::mfloat_t, float>, FAILMSG);
...
TEST(moving_average, sma) {
	static_assert(fea::sma<double, 10>::is_int_v == false, FAILMSG);
	static_assert(fea::sma<float, 10>::is_int_v == false, FAILMSG);
	static_assert(fea::sma<int64_t, 10>::is_int_v == true, FAILMSG);
	static_assert(fea::sma<int, 10>::is_int_v == true, FAILMSG);
...
TEST(moving_average, ema) {
	static_assert(fea::ema<double>::is_int_v == false, FAILMSG);
	static_assert(fea::ema<float>::is_int_v == false, FAILMSG);
	static_assert(fea::ema<int64_t>::is_int_v == true, FAILMSG);
	static_assert(fea::ema<int>::is_int_v == true, FAILMSG);

	static_assert(std::is_same_v<typename fea::ema<double>::mfloat_t, double>,
			FAILMSG);
	static_assert(
			std::is_same_v<typename fea::ema<float>::mfloat_t, float>, FAILMSG);
	static_assert(std::is_same_v<typename fea::ema<int64_t>::mfloat_t, double>,
			FAILMSG);
	static_assert(
			std::is_same_v<typename fea::ema<int>::mfloat_t, float>, FAILMSG);
...
TEST(moving_average, wma) {
	static_assert(fea::wma<double, 10>::is_int_v == false, FAILMSG);
	static_assert(fea::wma<float, 10>::is_int_v == false, FAILMSG);
	static_assert(fea::wma<int64_t, 10>::is_int_v == true, FAILMSG);
	static_assert(fea::wma<int, 10>::is_int_v == true, FAILMSG);
...
TEST(moving_average, mm) {
	static_assert(fea::mm<double, 10>::is_int_v == false, FAILMSG);
	static_assert(fea::mm<float, 10>::is_int_v == false, FAILMSG);
	static_assert(fea::mm<int64_t, 10>::is_int_v == true, FAILMSG);
	static_assert(fea::mm<int, 10>::is_int_v == true, FAILMSG);
